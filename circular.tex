...
Similarly, using the relation $N_1\sim 0$ and the equality \eqref{Ycancel}, %(together with the fact that the operation of subtracting $h$ induces an automorphism of $\Z/r_3$),%the fact that $$(\sigma_1^{n_1-1}\sigma_2^{x_2}+\sigma_1^{r_2(r_3-1)-1}\sigma_2^{x_2-\uo/\vo\cdot r_1})\cdot \mu=X_{x_2-1}$$ for all $x_2\in\Z$, 
we get
\begin{align*}
...
\end{lemma}
\begin{proof}
Using the relation $N_1\sim 0$ and the equality \eqref{Ycancel}, % fact that $$(\sigma_1^{n_1-1}\sigma_2^{x_2}+\sigma_1^{r_2(r_3-1)-1}\sigma_2^{x_2-\uo/\vo\cdot r_1})\cdot \mu=X_{1+x_2}$$ for all $x_2\in\Z$, 
we get
\begin{align*}
...
\end{lemma}
\begin{proof}
Using the relation $N_1\sim 0$ and the equality \eqref{Ycancel}, %the fact that $$(\sigma_1^{n_1-1}\sigma_2^{x_2}+\sigma_1^{r_2(r_3-1)-1}\sigma_2^{x_2-\uo/\vo\cdot r_1})\cdot \mu=X_{1+x_2}$$ for all $x_2\in\Z$, we have 
we get
\begin{align*}
...
%\end{align*}
%
%This is almost what we want, we only need the change the upper sum bounds slightly. We will do this using the fact that the unary operations of adding $q-ur_2-2$ induces an automorphism of $\Z/r_3$.
%\begin{align*}
